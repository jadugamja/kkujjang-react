...
const NoticeListContainer = () => {
  ...
  return (
    <>
      <NoticeListBox width="100%">
        <BoardTitle type="notice" />
        <NoticeWrapper row="end" marginBottom="25px" marginRight="2.25rem">
          <SearchBar
            searchType="제목"
        ...
        <NoticeListBox width="100%" height="fit-content" padding="0.625rem 2.625rem">
